...
if (!isset($_SESSION['authenticated'])) {
    $stored_hashed_password = '$2y$10$m0jlw5A6vootsRQ5OIcIJeYkp0ekJWeBpliQuoCL8pxQ6mlP0A/YG'; // Use PASSWORD_DEFAULT hash u can use this site https://phppasswordhash.com/ for generate ur password >  Gunakan hash PASSWORD_DEFAULT Anda dapat menggunakan situs ini https://phppasswordhash.com/ untuk menghasilkan kata sandi Anda
